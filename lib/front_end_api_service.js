...
export const getMyProfile = async (token) => {
  ...
  console.log('[DEBUG] getMyProfile initial response:', JSON.stringify(data, null, 2));
  ...
  console.log('[DEBUG] Complete device details:', JSON.stringify(devices, null, 2));
  
  // Log battery levels specifically
  devices.forEach(device => {
    console.log(`[DEBUG] Device ${device.id} battery level:`, device.battery);
  });
...
export const getDevices = async () => {
  ...
  console.log('[DEBUG] getDevices response:', JSON.stringify(data, null, 2));
...
export const getDeviceById = async (deviceId, token) => {
  ...
  console.log(`[DEBUG] getDeviceById response for device ${deviceId}:`, JSON.stringify(data, null, 2));
  ...
  console.log(`[DEBUG] Processed device ${deviceId} data:`, device);
  return device;
};
